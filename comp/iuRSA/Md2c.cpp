...
static void __fastcall MD2Transform(unsigned char [16], unsigned char [16], unsigned char [16]);
//static void __fastcall MD2_memcpy(POINTER, POINTER, unsigned int);
//static void __fastcall MD2_memset(POINTER, int, unsigned int);
#define MD2_memcpy(POINTER1, POINTER2, len) memcpy(POINTER1, POINTER2, len)
#define MD2_memset(POINTER1, val, len) memset(POINTER1, val, len)
 ...
 */
void __fastcall MD2Init (MD2_CTX *context)
{
  context->count = 0;
...
/* MD2 block update operation. Continues an MD2 message-digest
     ...
     context.
 */
void __fastcall MD2Update( // (context, input, inputLen)
 ...
 */
void __fastcall MD2Final (//digest, context)
...
/* MD2 basic transformation. Transforms state and updates checksum
     based on block.
 */
static void __fastcall MD2Transform (//state, checksum, block)
 ...
 */
/*
static void __fastcall MD2_memcpy (output, input, len)
POINTER output;
POINTER input;
unsigned int len;
{
 ...
 */
/*
static void __fastcall MD2_memset (output, value, len)
POINTER output;
int value;
unsigned int len;
{
